<template>
    <div class="p-4">
        <div class="row mb-4">
            <p class="s-text" v-if="this.$route.params.id">Users <i class="fas fa-angle-right"></i> Edit Users</p>
            <p class="s-text" v-else>Users <i class="fas fa-angle-right"></i> Create Users</p>
            <div class="col-md-4 col-6 header-col">
                <h3 class="heading" v-if="this.$route.params.id">Edit Users</h3>
                <h3 class="heading" v-else>Add Users</h3>
            </div>
            ...
            <form @submit.prevent="EditTeacher()" novalidate>
                <div class="table-main p-3">
                    ...
                    <div class="row">
                        ...
                        <p class="s-text">Role Information</p>
                        <label for="desktopSlider" class="form-label">Role*</label>
                        <div class="col-md-12 mb-3">
                            <select class="form-control form-select" id="role" v-model="from.role">
                                ...
                                <option value="Teacher" class="text2">Teacher</option>
                                <option value="Student" class="text2">Student</option>
                            </select>
                        </div>
                    </div>
