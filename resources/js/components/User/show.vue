        ...
        <div class="table-main">
            <div class="row p-2">
                <div class="col-md-6 col-12 left-side-filttle">
                    <div class="status-filter flex-start gap-4">
                        ...
                        <p class="active-lable2 mb-0 pointer">Admin</p>
                        <p class="active-lable2 mb-0 pointer">Teacher</p>
                        <p class="active-lable2 mb-0 pointer">Student</p>
                    </div>
            ...
            <div v-else>
                            ...
                            <tr v-for="(items, index) in teacher">
                                ...
                                <td>
                                    <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit data">
                                        <router-link :to="{ name: 'userEdit', params: { id: items.id } }" class="import2 add-cc hover-cc py-2">
                ...
                <Bootstrap5Pagination :show-disabled=true :limit="5" :data="currentPagination"
                    @pagination-change-page="fetchShowuser" />
...
export default {
    ...
    methods: {
        ...mapActions('teacher', ['fetchShowuser', 'deleteTeacher', 'fetchTeacherSearch']),
        CategorySearchWord() {
