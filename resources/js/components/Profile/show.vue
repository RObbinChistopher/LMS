<template>
    <div class="p-4">
        ...
        <div class="table-main p-3" v-else>
            ...
            <form @submit.prevent="UpdateProfilePassword()" novalidate>
...
export default {
    ...
    methods: {
        ...mapActions('auth', ['fetchloginUser']),
        ...
        async UpdateProfile() {
            ...
            let url = config.apiBaseUrl + `update-profile`;
        ...
        async UpdateProfilePassword() {
            ...
            if (!this.from.confirm_password) {
                this.errors.push('Your Confirm Password Is Required');
            }
            ...
            let url = config.apiBaseUrl + `update-profile-password`;
            ...
            try {
                ...
                this.loading = false;
                this.from.password = "";
                this.from.confirm_password = "";
                toast.success('Your Profile Password Update Successfully');
            } catch (error) {
                console.error("API call error:", error);
                this.loading = false;
            }
    ...
    mounted() {
        this.fetchloginUser(this.$route.params.id)
    }
};
</script>
