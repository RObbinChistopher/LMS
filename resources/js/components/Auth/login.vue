        ...
        <div class="offset-md-1 parent-accordion p-3 login_page" id="parent-accordion">
            <div class="p-3">
                ...
                <div class="flex-col gap-0">
                    ...
                    <p class="text" style="color: #361d67;">Continue with Inpath</p>
                </div>
                <form @submit.prevent="onSubmitLoginForm" class="input-container">
                    ...
                    <button class="save-btn-login mb-2 mt-3" :disabled="loading">
                        <span v-if="!loading" style="font-weight: 800;">Continue with email</span>
